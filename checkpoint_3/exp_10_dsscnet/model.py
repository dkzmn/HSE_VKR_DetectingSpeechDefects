...
class DSSCNet(nn.Module):
    def __init__(self, n_mels=80, n_frames=320, num_classes=2, base_c=64, num_blocks=4, reduction=8, n_letters=0, dropout=0.3):
        super().__init__()
...
def get_model(n_mels=80, n_frames=320, num_classes=2, n_letters=0, **kwargs):
    return DSSCNet(n_mels=n_mels, n_frames=n_frames, num_classes=num_classes, n_letters=n_letters, **kwargs)
